...
describe "#multiply" do
  ...
  expect(multiply([10,10,2])).to eq(200)
 end
...
describe "#factorial" do
  ...
  expect(nFactorial(0)).to eq(1)
 end 
  it "computes the factorial of 1" do
  expect(nFactorial(1)).to eq(1)
 end 
  it "computes the factorial of 2" do
  expect(nFactorial(2)).to eq(2)
 end 
  it "computes the factorial of 5" do 
  expect(nFactorial(5)).to eq(120)
 end 
  it "computes the factorial of 10" do
  expect(nFactorial(10)).to eq(3628800)
 end 
end
